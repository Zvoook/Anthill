...
public:
    ...
    bool in_anthill() { return (((x > window_weidth / 2 - start_radius / 2) || (x < window_weidth / 2 + start_radius / 2)) && ((y > window_high / 2 - start_radius / 2) || (y < window_high / 2 + start_radius / 2))); }
